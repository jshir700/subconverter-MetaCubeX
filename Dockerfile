...
ARG BUILD_DATE=""
LABEL \
  org.opencontainers.image.title="subconverter-MetaCubeX" \
  org.opencontainers.image.description="subconverter-MetaCubeX - subscription converter" \
  org.opencontainers.image.url="https://github.com/jshir700/subconverter-MetaCubeX" \
  org.opencontainers.image.source="https://github.com/jshir700/subconverter-MetaCubeX" \
